...
# ── StarTrading Strategy tool ──────────────────────────────────────────────────

@mcp.tool()
def star_trading_analysis(symbol: str) -> dict:
    """Analyze high-probability SMC setups using StarTrading's methodology.
    Includes REQX detection, Daily bias (rejections), and FVG protection.
    """
    return get_star_trading_analysis(symbol)
